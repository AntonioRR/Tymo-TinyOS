...
implementation {
  components ActiveMessageC/*,PacketLinkLayerC*/;
  ...
  components MHServiceC, DymoServiceC, NetControlM, DymoTableC, LedsC;
  
    //Adding by Antonio Rosa
 // components   PacketLink;
  //components LedsC;
  ...
  MHServiceC.PacketAcknowledgements        -> MHQueue;
 
 //adding by Antonio Rosa PacketLink
 // MHServiceC.PacketLink   ->  PacketLinkLayerC;
 // MHServiceC.BareSend     ->  PacketLinkLayerC;
  //MHServiceC.Leds      ->  LedsC;
  #ifdef LOW_POWER_LISTENING
  MHServiceC.LowPowerListening -> ActiveMessageC;
 #endif
  ...
  DymoServiceC.PacketAcknowledgements        -> DymoQueue;
